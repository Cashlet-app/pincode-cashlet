      ...
      <View style={styleMainContainer ? styleMainContainer : styles.container}>
        {status === PinStatus.choose &&
          <PinCodeChoose
            ...
            subtitleChoose={this.props.subtitleChoose || ""}
            ...
            titleChoose={this.props.titleChoose || "Create a passcode to secure your Cashlet account"}
            titleComponent={this.props.titleComponent}
            titleConfirm={this.props.titleConfirm || "Create a passcode to secure your Cashlet account"}
