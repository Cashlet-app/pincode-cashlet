...
class PinCodeEnter extends React.PureComponent<IProps, IState> {
  ...
  constructor(props: IProps) {
    super(props)
    this.state = { pinCodeStatus: PinResultStatus.initial, locked: false, cancelTouchID: false, showTouchID: false }
    ...
    return (
      <View
        ...
        <PinCode
          ...
          cancelTouchID={this.state.cancelTouchID}
          isEnter={this.props.isEnter}
          isReset={this.props.isReset}
          triggerTouchID={this.triggerTouchID}
