      ...
      <TouchableHighlight
        ...
        <View
          ...
          {!this.props.iconButtonDeleteDisabled && (
            <Image source={require('./design/clear.png')} style={[styles.deleteButton, { opacity: opacity }]} />
          )}
        </View>
      </TouchableHighlight>
    )
      ...
      <View
        ...
        <View style={styles.flexCirclePassword}>
          ...
          <View style={styles.borderViewRight}>
            {!isPincodeVisible ? (
              <TouchableOpacity onPress={() => this.handlePincodeVisible()} style={{ flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
