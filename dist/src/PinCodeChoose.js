...
class PinCodeChoose extends React.PureComponent {
    constructor(props) {
        ...
        this.state = { status: PinCode_1.PinStatus.choose, pinCode: '', showTouchID: false };
